...
class TestSAC(unittest.TestCase):
    ...
    def test_normalization_simple(self):
        ...
        self.assertAlmostEqual(1, unnormalized_value.item(), places=3)

        self.assertAlmostEqual(0.001, sac.network.scale.data.item(), places=3)
        self.assertAlmostEqual(1, sac.network.shift.data.item(), places=3)
