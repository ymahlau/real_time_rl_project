...
class RTAC:
    ...
    #beta = actor-critic loss factor
    #gamma = discount factor
    #alpha = entropy scale
    def __init__(self,env, eval_env = None, alpha = 0.2, gamma = 0.99, lr = 0.0003, beta = 0.1 , buffer_size = 10000, batch_size = 256, hidden_size = 256, num_hidden = 2, shared_parameters = False):
        self.ALPHA = alpha
        self.BETA = beta
        self.GAMMA = gamma
        self.LR = lr
        ...
        while True:
            ...
            while not done:
                ...
                if self.replay.capacity_reached():
                    ...
                    loss = self.BETA * loss_pol + (1 - self.BETA) * loss_value
                    """
                    Update parameters
                    """
